...
test("MessageList passes correct props to ToolCallDisplay component", () => {
  ...
  // Verify the ToolCallDisplay component is rendered
  expect(screen.getByTestId("tool-call-display")).toBeDefined();

  // Verify the tool name is displayed (through our mock)
  expect(screen.getByText("str_replace_editor")).toBeDefined();
});
